 ...
 * @since 24.11.2015
 * @deprecated Use {@link ExampleUserModel} instead
 */
public class ExampleUserModelOld extends DatabaseModel
{
	// CONSTRUCTOR	--------------------
	 ...
	 * will be added.
	 */
	public ExampleUserModelOld(Collection<? extends Attribute> attributes)
	{
