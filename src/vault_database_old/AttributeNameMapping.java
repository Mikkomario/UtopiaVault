...
import vault_generics.NameMappingRule;
 ...
 * @since 18.9.2015
 * @deprecated Code moved to {@link VariableNameMapping}
 */
public class AttributeNameMapping
{
	...
	{	
		...
		for (NameMappingRule rule : this.rules)
		{
			...
			{
				String attributeName = rule.getVariableName(columnName).toLowerCase();
