...
import utopia.java.vault.generics.ColumnVariable;
import utopia.java.vault.generics.CombinedModel;
import utopia.java.vault.generics.Table;
import utopia.java.vault.generics.TableModel;
...
public class ComparisonCondition extends SingleCondition
{
	...
	public static Option<Condition> createVariableSetEqualsCondition(ImmutableList<? extends ColumnVariable> variables,
                                                                     CombinedCondition.CombinationOperator combinationOperator, boolean skipNullVariables)
	{
	...
	public static Option<Condition> createVariableSetCondition(ImmutableList<? extends ColumnVariable> variables,
                                                               CombinedCondition.CombinationOperator combinationOperator, Operator comparisonOperator, boolean skipNullVariables)
	{
	...
	{
		return createVariableSetEqualsCondition(variables, CombinedCondition.CombinationOperator.AND,
				skipNullVariables);
	}
