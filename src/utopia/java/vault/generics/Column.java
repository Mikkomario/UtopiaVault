...
public class Column extends VariableDeclaration
{
	 ...
	 * to the correct type
	 * @throws VariableNameMapping.NoVariableForColumnException If the column name couldn't be mapped to a
	 * variable name
	 */
	public Column(Table table, String columnName, DataType type, boolean nullAllowed, 
			boolean primary, boolean autoIncrement, Value defaultValue) throws VariableNameMapping.NoVariableForColumnException
	{
