...
import utopia.java.vault.database.Condition;
...
import utopia.java.vault.database.Join;
import utopia.java.vault.database.OrderBy;
import utopia.java.vault.database.Selection;
...
public class ExampleDatabaseQueries
{
	 ...
	 * @throws Table.NoSuchColumnException If the role table doesn't have a primary column
	 * @throws DatabaseUnavailableException If the database couldn't be accessed
	 */
	public static ExampleRoleModel insertRole(int roleIndex, String roleName, 
			Database connection) throws 
			DatabaseException, Table.NoSuchColumnException, DatabaseUnavailableException
	{
